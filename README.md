...
### Для работы необходим [.Net 4.5 или выше](https://www.microsoft.com/ru-ru/download/details.aspx?id=53345). Начиная с v1.4.3.9 ошибки при работе в .Net 4.0 исправлены.
...
**v1.4.2.1**<br/>
- Добавлена возможност отключения проверки обновления при запуске(полезно для пользователей Chocolatey, т.к. там есть `cup all -y`).
...
**v1.4.4.1**<br/>
- Добавлена функция *Отладочная инф.*(Debug Info), копирует отладочную информацию в буфер обмена.

**v1.5.0.0**<br/>
- Добавлена функция отображения подсказки текущего языка рядом с позицией каретки(текстового курсора).
- Добавлено возможность выбора разных цветов/шрифтов для разных раскладок в подсказках языка.
...
### Mahou requires [.Net 4.5 or greater](https://www.microsoft.com/en-us/download/details.aspx?id=53345) to work properly. Begining from v1.4.3.9 error when running on .Net 4.0 were fixed.
