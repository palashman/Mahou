...
public class Languages
{
	...
	public static Dictionary<Element, string> English = new Dictionary<Element, string>() { 
		...
		{ Element.TT_Add1Space, "If enabled, ONE space will be added to the last word." }, 
		...
		{ Element.TT_PersistentLayout, "Write here process names in which you want to have persistent layout, separators are spaces(though symbols as ,.^& etc are supported too)."},
		#endregion
		#region Messages
